...
public class Sports_Captain extends javax.swing.JFrame {
    ...
    public Sports_Captain() {
        ...
        try{
            ImageIcon sports1 = new ImageIcon(path + "/" + ls.get(0) + ".jpeg");
            ImageIcon sports2 = new ImageIcon(path + "/" + ls.get(0) + ".jpeg");
            ImageIcon sports3 = new ImageIcon(path + "/" + ls.get(0) + ".jpeg");
            ImageIcon sports4 = new ImageIcon(path + "/" + ls.get(0) + ".jpeg");
