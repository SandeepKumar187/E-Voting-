...
public class Vote_all extends javax.swing.JFrame {
    ...
    public Vote_all() {
        ...
        try {
            if (Lheadboy.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please add the Candidates for Head Boy to Vote", "Error", WIDTH, i);
            } else {
        ...
        try {
            if (Lheadgirl.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please add the Candidates for Head Girl to Vote", "Error", WIDTH, i);
            } else {
        ...
        try {
            if (Lcultural.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please add the Candidates for Cultural Captain to Vote", "Error", WIDTH, i);
            } else {
        ...
        try {
            if (Lsports.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please add the Candidates for Sports Captain to Vote", "Error", WIDTH, i);
            } else {
    ...
    ArrayList Lheadboy = new ArrayList();
    ArrayList Lheadgirl = new ArrayList();
    ArrayList Lcultural = new ArrayList();
    ArrayList Lsports = new ArrayList();
    ...
    private void initComponents() {
        ...
        jButton7.setBounds(20, 620, 150, 40);

        Bname4.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(450, 630, 310, 20);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(330, 160, 620, 70);
        ...
        jLabel13.setText("ARMY PUBLIC SCHOOL ASC C&C");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(470, 650, 280, 20);

        Sname1.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Sname3.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Bname3.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Bname1.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Gname1.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Cname1.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Bname2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Gname4.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Cname3.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Gname2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Gname3.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Cname4.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Cname2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Sname4.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        Sname2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!HeadBoy.equals("")
            ...
            JOptionPane.showMessageDialog(this, "Your Vote has been Saved\nYou Voted for\nHead Boy              - "
                    ...
                    + "\nSports Captain    - " + Sports + "\nThank You", "Info", JOptionPane.WIDTH, i);
            ...
            JOptionPane.showMessageDialog(this, "Make sure you have Selected all the Captians", "Error", WIDTH, i);
        }
