...
public class Head_Girl extends javax.swing.JFrame {
    ...
    public Head_Girl() {
        ...
        try {
            ImageIcon headgirl1 = new ImageIcon(path + "/" + ls.get(0) + ".jpeg");
            ImageIcon headgirl2 = new ImageIcon(path + "/" + ls.get(1) + ".jpeg");
            ImageIcon headgirl3 = new ImageIcon(path + "/" + ls.get(2) + ".jpeg");
            ImageIcon headgirl4 = new ImageIcon(path + "/" + ls.get(3) + ".jpeg");
